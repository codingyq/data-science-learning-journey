...
file = open("../samples/08 FileReading Open _ 0914.txt", "a")
...
file = open("../samples/09 Writing and Appending Files _ 0914.txt", "w")
file.write("Hi, this is a new file for 09 writing file")
file.close()

# use "w" to create a new file - html as extension
file = open("../samples/09 Writing and Appending Files _ 0914.html", "w")
